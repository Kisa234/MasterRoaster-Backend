...
export class MovimientoAlmacenRepositoryImpl implements MovimientoAlmacenRepository {
  ...
  createMovimiento(dto: CreateMovimientoAlmacenDto, tx?: Prisma.TransactionClient): Promise<MovimientoAlmacenEntity> {
    return this.movimientoDatasource.createMovimiento(dto, tx);
  }
