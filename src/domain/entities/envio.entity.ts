...
export class EnvioEntity {
    constructor(
        ...
        public medio_envio?: string | null, // 👈 reemplaza a id_transportista — texto libre
    ...
    public static fromObject(obj: { [key: string]: any }): EnvioEntity {
        const {
            ...
            registrado_por_id, medio_envio, numero_tracking, costo_envio, quien_paga,
        ...
        return new EnvioEntity(
            ...
            registrado_por_id,
            medio_envio ?? null, numero_tracking ?? null, costo_envio ?? null, quien_paga ?? null,
...
// Variante "ConDetalle" — Envio + su Paquete (con items) + Dirección.
// Ya no incluye Transportista: medio_envio es un campo plano de EnvioEntity, no una relación.
...
export class EnvioConDetalleEntity extends EnvioEntity {
    constructor(
        ...
        super(
            ...
            base.fecha_registro, base.registrado_por_id, base.medio_envio, base.numero_tracking,
    ...
    public static fromObject(obj: { [key: string]: any }): EnvioConDetalleEntity {
        ...
        // ⚠️ estos 2 nombres deben coincidir EXACTO con el `include` del datasource
        const { paquete, direccion } = obj;
        ...
        return new EnvioConDetalleEntity(baseEntity, paqueteEntity, direccionEntity);
    }
}