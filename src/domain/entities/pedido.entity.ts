export class PedidoEntity {
    ...
    static fromObject(obj: { [key: string]: any }): PedidoEntity {
        const { id_pedido, fecha_pedido, tipo_tueste, cantidad_tostado, estado_pedido, observaciones, cliente_id, asignado_a_id, fecha_asignacion,eliminado } = obj;
        ...
        if(!cliente_id) throw new Error('El ID del cliente es requerido');
        ...
        return new PedidoEntity(id_pedido, fecha_pedido, tipo_tueste, cantidad_tostado, estado_pedido, observaciones, cliente_id, asignado_a_id, fecha_asignacion, eliminado);
    }
}
