...
export class UpdateLoteDto {
    ...
    static update(props: { [key: string]: any }): [string?, UpdateLoteDto?] {
        const { id_lote, productor, finca, region, departamento, fecha_compra, peso, estado, 
                variedades_id_variedad, user_id_user, pedido_id_pedido, variedades,proceso, analisis } = props;
        ...
        return [undefined, new UpdateLoteDto(
            id_lote, productor, finca, region, departamento, fechaParsed, peso, 
            variedades_id_variedad, user_id_user, pedido_id_pedido, variedades, proceso,analisis
        )];
    }
}
