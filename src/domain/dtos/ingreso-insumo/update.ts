export class UpdateIngresoInsumoDto {
  private constructor(
  ...
  static update(props: { [key: string]: any }): [string?, UpdateIngresoInsumoDto?] {
    ...
    return [undefined, new UpdateIngresoInsumoDto(nPrecio)];
  }
}